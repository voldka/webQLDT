        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                <li class="nav-item padding">
                    <a class="nav-link active" aria-current="page" href="<c:url value="/student-home"/>"><img
                ...
                <li class="nav-item padding "><a class="nav-link" href="<c:url value="/student-thong-ke"/>"><img
