...
<section class="py-5" style="padding-top: 0px!important;">
    <form id="formLogin" class="modal-content animate" action="<c:url value="/teacher-list-type-of-topic"/>" method="post">
        <div class="container px-4 px-lg-5 mt-5">
            <div class="row g-3 align-items-center teacher-edit">
                <div class="form-group" style="text-align: center;">
                    <label class="col-sm-3 control-label no-padding-right">name type</label>
                    <div class="col-sm-9" style="margin: auto;">
                        <input  required="" type="text" class="form-control" id="content" name="name" value="${name}"/>
                    </div>
                </div>
            </div>
            <br>
