...
<section class="py-5" style="padding-top: 0px!important;">
    <div class="container px-4 px-lg-5 mt-5">
        <div class="notification-container-add"><a class="nav-link"
                                                   href="<c:url value="/teacher-edit-TypeOfTopic?action=add"/>">
                        ...
                        <c:forEach var="index" begin="0" end="${countModel-1}">
                            <c:forEach var="item" items="${model}" begin="${index}" end="${index}">
                                <tr class=" listProject_section-table--hover">
                                    ...
                                    <td style="width: 8%;">
                                        <form action="<c:url value="/teacher-edit-TypeOfTopic"/>" method="get"
                                              style="margin: 4px;">
                                        ...
                                        <form action="<c:url value="/teacher-list-type-of-topic"/>"
                                              method="post"
                                              style="margin: 4px;">
